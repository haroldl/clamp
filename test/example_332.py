...
relative_spec = importlib.util.find_spec(".sub", "relative_pkg")
print(relative_spec.name)
print(importlib.util.find_spec("definitely_missing_importlib_spec") is None)
